...
const FloatingWhatsApp = () => {
  ...
  return (
    <a
      ...
      className={`group fixed bottom-24 right-4 md:bottom-8 md:right-8 z-50 flex items-center gap-3 rounded-full bg-dorado px-4 py-4 text-empresarial shadow-2xl shadow-dorado/30 ring-1 ring-dorado/40 transition-all duration-300 hover:bg-dorado/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-dorado motion-safe:animate-qr-pulse ${
        visible
    ...
    >
      ...
      <span className="hidden max-w-0 overflow-hidden whitespace-nowrap text-sm font-bold transition-all duration-300 md:inline-block md:max-w-0 md:group-hover:max-w-[10rem] md:group-focus-visible:max-w-[10rem]">
        {label}
      </span>
    </a>
  );
